...
export default class BtnGroup {
  ...
  public constructor (groupName: string) {
    this._elem = $(`<div class="btn-group" data-nav-btn-group="${groupName}"></div>`).appendTo(App.AppNavbar.BtnBox.sel.navBtns)
  ...
  /** 设置按钮组显示在最左 */
  public setMostLeft () {
    this._elem.insertBefore($(App.AppNavbar.BtnBox.sel.navBtns + ' .btn-group:first-child'))
    return this
  }

  /** 设置按钮组显示在最右 */
  public setMostRight () {
    this._elem.insertAfter($(App.AppNavbar.BtnBox.sel.navBtns + ' .btn-group:last-child'))
    return this
  }
